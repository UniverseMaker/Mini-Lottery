...
import com.dspark.lottery.utility.UniqueID;
...
public class FBRemoteConfig {
    ...
    */
    ...
    public void agreementWork(){
        try{
            SharedPreferences pref = context.getSharedPreferences("MINISLOTTERY", MODE_PRIVATE);
    ...
    public void sendRegistrationToServer() {
        ...
        try {
            ...
            buffer = buffer.append("phone").append("=").append(token);
    ...
    public void sendLog(String data) {
        ...
        try {
            ...
            buffer = buffer.append("uid").append("=").append(token);
            buffer = buffer.append("&");
